...
from vectorDB_setup import setup_milvus_collection




# Test vectorDB setup
def test_vectorDB_setup(collection_name: str):
    # Setup Milvus collection
    setup_milvus_collection(collection_name)
test_vectorDB_setup(collection_name="VectorDB for Cypher paths and descriptions")
